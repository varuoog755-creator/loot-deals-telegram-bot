...
with open("earnkaro_full_catalog.json", "r", encoding="utf-8") as f:
    deals = json.load(f)
...
coupons = [
    {
        ...
        "used": "4.8k used",
        "expires": "30 Sep 2026",
        "link": "https://tinyurl.com/24f545mk"
    },
    {
        "id": "c2",
    ...
    },
    {
        ...
        "desc": "Flat ₹300 instant discount on audio & smart devices",
        "code": "TATA300",
    ...
    },
    {
        ...
        "used": "3.1k used",
        "expires": "05 Oct 2026",
        "link": "https://tinyurl.com/24mxfptc"
    },
    {
        "id": "c5",
        "store": "Ajio Trends",
        ...
        "used": "5.7k used",
        "expires": "01 Oct 2026",
        "link": "https://tinyurl.com/2csvcffq"
    }
]
...
<head>
  ...
  <title>BigRedHub — Real EarnKaro Deals & Verified Coupons</title>
  <meta name="description" content="Live EarnKaro deals with real photos, pricing & affiliate shortlinks. Save up to 86% on boAt, Myntra, Amazon, Tata CLiQ.">
...
<body>
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-pill">● REAL EARNKARO DEALS SYNCED</div>
...
html += '''      </div>
  ...
  <section class="section" id="deals">
    <div class="container">
      ...
      <p class="section-subtitle">Real products with live pricing & verified affiliate shortlinks</p>
...
for deal in deals:
    html += f'''        <div class="deal-card" data-category="{deal['category']}" data-title="{deal['title'].lower()}" data-store="{deal['store'].lower()}" data-id="{deal['id']}">
          ...
          <div class="deal-body">
            ...
            <a href="{deal['short_url']}" target="_blank" rel="noopener noreferrer" class="deal-btn">
              Grab Deal ⚡
            </a>
          </div>
        </div>
...
print("✅ Final White & Black Minimalist landing.html with real EarnKaro deals ready!")
